# HVA Finetune V2.5 - Method 2: L4 GPU + Full BF16 (Bulletproof)
# =================================================================
# This is the SUCCESSFUL method for fine-tuning Qwen 2.5 3B on Google Colab L4.
# METHODOLOGY: "Bypass Quantization, Embrace L4 VRAM"
# -----------------------------------------------------------------
# 1. Environment: Colab L4 Runtime (24GB VRAM).
# 2. Dependency Strategy: Manual Install + Restart Session (Avoids caching loops).
# 3. Model Loading: Full torch.bfloat16 precision (No bitsandbytes/4-bit).
#    - Benefits: Faster, Higher Quality, No dependency errors.
# 4. Training Stability: "Bulletproof Mode"
#    - Batch Size: 1 (Safest possible).
#    - Gradient Accumulation: 32 (Maintains effective batch size of 32).
#    - Memory Wiper: Explicit GC and Cache Clear at start.
# -----------------------------------------------------------------
